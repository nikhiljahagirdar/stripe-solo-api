...
describe('Date Utilities', () => {
    describe('getYearTimestampRange', () => {
        it('should return correct timestamp range for 2024', () => {
            const range = (0, date_utils_1.getYearTimestampRange)(2024);
        ...
        it('should handle different years correctly', () => {
            const range2020 = (0, date_utils_1.getYearTimestampRange)(2020);
            const range2024 = (0, date_utils_1.getYearTimestampRange)(2024);
            const range2025 = (0, date_utils_1.getYearTimestampRange)(2025);
            expect(range2020.start).toBeLessThan(range2024.start);
            expect(range2024.start).toBeLessThan(range2025.start);
        });
        it('should be consistent across multiple calls', () => {
            const range1 = (0, date_utils_1.getYearTimestampRange)(2024);
            const range2 = (0, date_utils_1.getYearTimestampRange)(2024);
    ...
    describe('dateStringToUnixTimestamp', () => {
        it('should convert ISO date string to Unix timestamp', () => {
            const timestamp = (0, date_utils_1.dateStringToUnixTimestamp)('2024-01-01');
            expect(typeof timestamp).toBe('number');
            expect(timestamp).toBeGreaterThan(0);
        });
        it('should handle full ISO 8601 datetime', () => {
            const timestamp = (0, date_utils_1.dateStringToUnixTimestamp)('2024-01-01T12:00:00Z');
            expect(typeof timestamp).toBe('number');
            expect(timestamp).toBeGreaterThan(0);
        });
        it('should produce correct timestamp for known date', () => {
            const timestamp = (0, date_utils_1.dateStringToUnixTimestamp)('2024-01-01T00:00:00Z');
        ...
        it('should be different for different dates', () => {
            const ts1 = (0, date_utils_1.dateStringToUnixTimestamp)('2024-01-01');
            const ts2 = (0, date_utils_1.dateStringToUnixTimestamp)('2024-01-02');
    ...
    describe('dateStringToUTC', () => {
        it('should return a Date object', () => {
            const date = (0, date_utils_1.dateStringToUTC)('2024-01-01');
            expect(date instanceof Date).toBe(true);
        });
        it('should parse ISO date correctly', () => {
            const date = (0, date_utils_1.dateStringToUTC)('2024-01-15');
            expect(date.getUTCFullYear()).toBe(2024);
            expect(date.getUTCMonth()).toBe(0);
            expect(date.getUTCDate()).toBe(15);
        });
        it('should handle full ISO 8601 datetime', () => {
            const date = (0, date_utils_1.dateStringToUTC)('2024-06-15T14:30:00Z');
            expect(date.getUTCFullYear()).toBe(2024);
        ...
        it('should return valid Date for various formats', () => {
            ...
            formats.forEach(format => {
                const date = (0, date_utils_1.dateStringToUTC)(format);
                expect(date instanceof Date).toBe(true);
    ...
    describe('getPeriodDateRange', () => {
        it('should return null for invalid period', () => {
            const range = (0, date_utils_1.getPeriodDateRange)('invalid');
            expect(range).toBeNull();
        });
        it('should return date range for 7d period', () => {
            const range = (0, date_utils_1.getPeriodDateRange)('7d');
        ...
        it('should return date range for 30d period', () => {
            const range = (0, date_utils_1.getPeriodDateRange)('30d');
            expect(range).not.toBeNull();
            expect(range.start.getTime()).toBeLessThan(range.end.getTime());
        });
        it('should return date range for 90d period', () => {
            const range = (0, date_utils_1.getPeriodDateRange)('90d');
            expect(range).not.toBeNull();
        ...
        it('should return date range for 1y period', () => {
            const range = (0, date_utils_1.getPeriodDateRange)('1y');
            expect(range).not.toBeNull();
            const diff = range.end.getTime() - range.start.getTime();
            const days = diff / (1000 * 60 * 60 * 24);
        ...
        it('should have end date greater than start date', () => {
            ...
            periods.forEach(period => {
                const range = (0, date_utils_1.getPeriodDateRange)(period);
                expect(range.start.getTime()).toBeLessThan(range.end.getTime());
            });
        });
    });
    describe('getPeriodUnixTimestampRange', () => {
        it('should return null for invalid period', () => {
            const range = (0, date_utils_1.getPeriodUnixTimestampRange)('invalid');
            expect(range).toBeNull();
        });
        it('should return timestamp range for valid periods', () => {
            const periods = ['7d', '30d', '90d', '1y'];
            periods.forEach(period => {
                const range = (0, date_utils_1.getPeriodUnixTimestampRange)(period);
                expect(range).not.toBeNull();
                expect(range).toHaveProperty('start');
                expect(range).toHaveProperty('end');
                expect(typeof range.start).toBe('number');
        ...
        it('should have end timestamp greater than start timestamp', () => {
            const range = (0, date_utils_1.getPeriodUnixTimestampRange)('30d');
            expect(range.start).toBeLessThan(range.end);
        });
        it('should return timestamps in seconds', () => {
            const range = (0, date_utils_1.getPeriodUnixTimestampRange)('7d');
            const date = new Date(range.start * 1000);
            expect(date instanceof Date).toBe(true);
            expect(!Number.isNaN(date.getTime())).toBe(true);
        });
        it('should be consistent with date range calculation', () => {
            const dateRange = (0, date_utils_1.getPeriodDateRange)('30d');
            const tsRange = (0, date_utils_1.getPeriodUnixTimestampRange)('30d');
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle non-leap year correctly', () => {
            const range = (0, date_utils_1.getYearTimestampRange)(2023);
            const startDate = new Date(range.start * 1000);
            const endDate = new Date(range.end * 1000);
        ...
        it('should handle very old years', () => {
            const range = (0, date_utils_1.getYearTimestampRange)(1970);
            expect(range.start).toBeLessThan(range.end);
        });
        it('should handle future years', () => {
            const range = (0, date_utils_1.getYearTimestampRange)(2100);
            expect(range.start).toBeLessThan(range.end);
        });
    });
    describe('Timezone Consistency', () => {
        ...
        it('dateStringToUTC should preserve UTC conversion', () => {
            ...
            const date = (0, date_utils_1.dateStringToUTC)(dateString);
            expect(date.getUTCFullYear()).toBe(2024);
            expect(date.getUTCMonth()).toBe(0);
            expect(date.getUTCDate()).toBe(15);

 ...
 */
export const stripeKeys = pgTable(
  'stripe_keys',
  {
    id: serial('id').primaryKey(),
...
export const stripeAccounts = pgTable(
  'stripe_accounts',
  {
    ...
    userId: integer('user_id')
      .notNull()
      .references(() => users.id),
    stripe_key_id: integer('stripe_key_id')
      .notNull()
      .references(() => stripeKeys.id), // NEW: link to our stripe_keys row
  ...
  (table) => ({
    ...
    stripeKeyIdIdx: index('stripe_accounts_stripe_key_id_idx').on(
      table.stripe_key_id,
    ),
  }),
);
...
export const customerTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('customers_stripe_account_id_idx').on(
...
export const paymentIntentsTable = pgTable(
  'payment_intents',
  {
    ...
    stripeAccountId: integer('stripe_account_id') // NEW
      .notNull()
      .references(() => stripeAccounts.id),
    stripeCustomerId: text('stripe_customer_id').references(
      () => customerTable.stripeCustomerId,
    ),
    paymentIntentId: text('payment_intent_id').notNull().unique(),
    amount: decimal('amount', { precision: 12, scale: 2 }).notNull(),
    currency: text('currency').notNull(),
    status: text('status').notNull(),
    paymentMethodTypes: text('payment_method_types'), // JSON array of allowed payment method types
    paymentMethodId: text('payment_method_id'), // Associated payment method
    confirmationMethod: text('confirmation_method'), // 'automatic' or 'manual'
    captureMethod: text('capture_method'), // 'automatic' or 'manual'
    description: text('description'),
    receiptEmail: text('receipt_email'),
    setupFutureUsage: text('setup_future_usage'), // 'on_session', 'off_session', or null
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('payment_intents_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCustomerIdIdx: index('payment_intents_stripe_customer_id_idx').on(
...
export const invoiceTable = pgTable(
  'invoices',
  {
    ...
    userId: integer('user_id')
      .notNull()
      .references(() => users.id),
    stripeAccountId: integer('stripe_account_id')
      .notNull()
      .references(() => stripeAccounts.id),
    stripeCustomerId: text('stripe_customer_id').references(
      () => customerTable.stripeCustomerId,
    ...
    amount: decimal('amount', { precision: 12, scale: 2 }), // Can be null for draft invoices without line items
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('invoices_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
...
export const subscriptionTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('subscriptions_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
...
export const priceTable = pgTable(
  'prices',
  {
    ...
    unitAmount: decimal('unit_amount', { precision: 12, scale: 2 }), // Can be null for recurring prices without a fixed amount
    currency: text('currency').notNull(),
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('prices_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeProductIdIdx: index('prices_stripe_product_id_idx').on(
...
export const disputeTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('disputes_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const balanceTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('balance_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const balanceTransactionsTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('balance_transactions_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export type NewBalanceTransaction =
  typeof balanceTransactionsTable.$inferInsert;
...
export const chargesTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('charges_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCustomerIdIdx: index('charges_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
  }),
);
...
export const customerSessionsTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('customer_sessions_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCustomerIdIdx: index('customer_sessions_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
  }),
);
...
export const eventsTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('events_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const filesTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('files_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const fileLinksTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('file_links_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
 ...
 * Mandates
 */
export const mandatesTable = pgTable(
  'mandates',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('mandates_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCustomerIdIdx: index('mandates_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
  }),
);
 ...
 */
export const setupIntentsTable = pgTable(
  'setup_intents',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('setup_intents_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCustomerIdIdx: index('setup_intents_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
  }),
);
...
export const setupAttemptsTable = pgTable(
  'setup_attempts',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
    ...
    stripeSetupIntentId: text('stripe_setup_intent_id').references(
      () => setupIntentsTable.stripeSetupIntentId,
    ),
    status: text('status'),
    created: bigint('created', { mode: 'number' }),
    createdAt: timestamp('created_at').defaultNow().notNull(),
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('setup_attempts_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeSetupIntentIdIdx: index(
      'setup_attempts_stripe_setup_intent_id_idx',
    ).on(table.stripeSetupIntentId),
  }),
);
...
export const payoutsTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('payouts_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const refundsTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('refunds_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const tokensTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('tokens_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const confirmationTokensTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('confirmation_tokens_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const taxSettingsTable = pgTable('tax_settings', {
  ...
  accountId: integer('account_id')
    .notNull()
    .references(() => stripeAccounts.id)
    .unique(), // your internal account id
  ...
  manualTaxPercent: decimal('manual_tax_percent', { precision: 5, scale: 2 }), // e.g. 18.00
 ...
 */
export const taxCodesTable = pgTable(
  'tax_codes',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('tax_codes_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const taxRatesTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('tax_rates_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const shippingCodesTable = pgTable(
  'shipping_codes',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('shipping_codes_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const shippingRatesTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('shipping_rates_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const couponsTable = pgTable(
  'coupons',
  {
    ...
    amountOff: decimal('amount_off', { precision: 12, scale: 2 }), // Amount (in cents) to be discounted.
    percentOff: decimal('percent_off', { precision: 5, scale: 2 }), // Percent that will be discounted.
...
export const promotionCodesTable = pgTable(
  ...
  (table) => ({
    ...
    stripeCouponIdIdx: index('promotion_codes_stripe_coupon_id_idx').on(
...
export type UpdateSetting = Partial<
  Omit<Setting, 'settingsId' | 'userId' | 'createdAt'>
>;
...
export const RbackRolesPagesTable = pgTable(
  'rback_roles_pages',
  {
    id: serial('id').primaryKey(),
    roleId: integer('role_id')
...
export const paymentMethodsTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('payment_methods_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCustomerIdIdx: index('payment_methods_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
  }),
);
...
export const bankAccountsTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('bank_accounts_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCustomerIdIdx: index('bank_accounts_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
  }),
);
...
export const cardsTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('cards_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCustomerIdIdx: index('cards_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
  }),
);
...
export const cashBalanceTable = pgTable(
  'cash_balance',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('cash_balance_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCustomerIdIdx: index('cash_balance_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
  }),
);
...
export const cashBalanceTransactionsTable = pgTable(
  'cash_balance_transactions',
  {
    ...
    stripeAccountId: integer('stripe_account_id')
      .notNull()
      .references(() => stripeAccounts.id),
    stripeCashTransactionId: text('stripe_cash_transaction_id')
      .notNull()
      .unique(),
    stripeCustomerId: text('stripe_customer_id')
      .notNull()
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index(
      'cash_balance_transactions_stripe_account_id_idx',
    ).on(table.stripeAccountId),
    stripeCustomerIdIdx: index(
      'cash_balance_transactions_stripe_customer_id_idx',
    ).on(table.stripeCustomerId),
  }),
);
export type CashBalanceTransaction =
  typeof cashBalanceTransactionsTable.$inferSelect;
export type NewCashBalanceTransaction =
  typeof cashBalanceTransactionsTable.$inferInsert;
...
export const creditNotesTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('credit_notes_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeInvoiceIdIdx: index('credit_notes_stripe_invoice_id_idx').on(
      table.stripeInvoiceId,
    ),
    stripeCustomerIdIdx: index('credit_notes_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
  }),
);
...
export const customerBalanceTransactionsTable = pgTable(
  ...
  (table) => ({
    userIdIdx: index('customer_balance_transactions_user_id_idx').on(
      table.userId,
    ),
    stripeAccountIdIdx: index(
      'customer_balance_transactions_stripe_account_id_idx',
    ).on(table.stripeAccountId),
    stripeCustomerIdIdx: index(
      'customer_balance_transactions_stripe_customer_id_idx',
    ).on(table.stripeCustomerId),
  }),
);
export type CustomerBalanceTransaction =
  typeof customerBalanceTransactionsTable.$inferSelect;
export type NewCustomerBalanceTransaction =
  typeof customerBalanceTransactionsTable.$inferInsert;
...
export const invoiceItemsTable = pgTable(
  'invoice_items',
  {
    ...
    stripePriceId: text('stripe_price_id').references(
      () => priceTable.stripePriceId,
    ),
    amount: decimal('amount', { precision: 12, scale: 2 }),
    currency: varchar('currency', { length: 3 }),
    description: text('description'),
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('invoice_items_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeInvoiceIdIdx: index('invoice_items_stripe_invoice_id_idx').on(
      table.stripeInvoiceId,
    ),
    stripeCustomerIdIdx: index('invoice_items_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
    stripePriceIdIdx: index('invoice_items_stripe_price_id_idx').on(
      table.stripePriceId,
    ),
  }),
);
...
export const checkoutSessionsTable = pgTable(
  'checkout_sessions',
  {
    ...
    stripePaymentIntentId: text('stripe_payment_intent_id').references(
      () => paymentIntentsTable.paymentIntentId,
    ),
    clientSecret: text('client_secret'),
    status: text('status'),
    url: text('url'),
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('checkout_sessions_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCustomerIdIdx: index('checkout_sessions_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
...
export const paymentLinksTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('payment_links_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const subscriptionItemsTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('subscription_items_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeSubscriptionIdIdx: index(
      'subscription_items_stripe_subscription_id_idx',
    ).on(table.stripeSubscriptionId),
    stripePriceIdIdx: index('subscription_items_stripe_price_id_idx').on(
      table.stripePriceId,
    ),
  }),
);
...
export const subscriptionSchedulesTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index(
      'subscription_schedules_stripe_account_id_idx',
    ).on(table.stripeAccountId),
    stripeCustomerIdIdx: index(
      'subscription_schedules_stripe_customer_id_idx',
    ).on(table.stripeCustomerId),
    stripeSubscriptionIdIdx: index(
      'subscription_schedules_stripe_subscription_id_idx',
    ).on(table.stripeSubscriptionId),
  }),
);
export type SubscriptionSchedule =
  typeof subscriptionSchedulesTable.$inferSelect;
export type NewSubscriptionSchedule =
  typeof subscriptionSchedulesTable.$inferInsert;
...
export const taxIdsTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('tax_ids_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCustomerIdIdx: index('tax_ids_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
  }),
);
...
export const testClocksTable = pgTable(
  'test_clocks',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('test_clocks_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
 ...
 * Connect Section
 */
export const connectAccountsTable = pgTable(
  'connect_accounts',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
...
export const applicationFeesTable = pgTable(
  'application_fees',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('application_fees_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeChargeIdIdx: index('application_fees_stripe_charge_id_idx').on(
...
export const topUpsTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('top_ups_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const transfersTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('transfers_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const plansTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('plans_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
...
export const quotesTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('quotes_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCustomerIdIdx: index('quotes_stripe_customer_id_idx').on(
      table.stripeCustomerId,
    ),
  }),
);
 ...
 */
export const metersTable = pgTable(
  'meters',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('meters_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const meterEventsTable = pgTable(
  'meter_events',
  {
    ...
    stripeMeterId: text('stripe_meter_id').references(
      () => metersTable.stripeMeterId,
    ),
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('meter_events_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeMeterIdIdx: index('meter_events_stripe_meter_id_idx').on(
      table.stripeMeterId,
    ),
  }),
);
...
export const treasuryAccountsTable = pgTable(
  'treasury_accounts',
  {
    ...
    stripeAccountId: integer('stripe_account_id')
      .notNull()
      .references(() => stripeAccounts.id),
    stripeTreasuryAccountId: text('stripe_treasury_account_id')
      .notNull()
      .unique(),
    status: text('status'),
    currency: varchar('currency', { length: 3 }),
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('treasury_accounts_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const treasuryTransactionsTable = pgTable(
  'treasury_transactions',
  {
    ...
    stripeAccountId: integer('stripe_account_id')
      .notNull()
      .references(() => stripeAccounts.id),
    stripeTreasuryTransactionId: text('stripe_treasury_transaction_id')
      .notNull()
      .unique(),
    stripeTreasuryAccountId: text('stripe_treasury_account_id').references(
      () => treasuryAccountsTable.stripeTreasuryAccountId,
    ),
    type: text('type'),
    amount: decimal('amount', { precision: 12, scale: 2 }),
    currency: varchar('currency', { length: 3 }),
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('treasury_transactions_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeTreasuryAccountIdIdx: index(
      'treasury_transactions_stripe_treasury_account_id_idx',
    ).on(table.stripeTreasuryAccountId),
  }),
);
export type TreasuryTransaction = typeof treasuryTransactionsTable.$inferSelect;
export type NewTreasuryTransaction =
  typeof treasuryTransactionsTable.$inferInsert;

export const issuingCardholdersTable = pgTable(
  'issuing_cardholders',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('issuing_cardholders_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const issuingCardsTable = pgTable(
  'issuing_cards',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
    ...
    stripeCardholderId: text('stripe_cardholder_id').references(
      () => issuingCardholdersTable.stripeCardholderId,
    ),
    status: text('status'),
    type: text('type'),
    last4: varchar('last4', { length: 4 }),
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('issuing_cards_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
    stripeCardholderIdIdx: index('issuing_cards_stripe_cardholder_id_idx').on(
      table.stripeCardholderId,
    ),
  }),
);
...
export const issuingAuthorizationsTable = pgTable(
  'issuing_authorizations',
  {
    ...
    stripeIssuingCardId: text('stripe_issuing_card_id').references(
      () => issuingCardsTable.stripeIssuingCardId,
    ),
    status: text('status'),
    amount: decimal('amount', { precision: 12, scale: 2 }),
    currency: varchar('currency', { length: 3 }),
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index(
      'issuing_authorizations_stripe_account_id_idx',
    ).on(table.stripeAccountId),
    stripeIssuingCardIdIdx: index(
      'issuing_authorizations_stripe_issuing_card_id_idx',
    ).on(table.stripeIssuingCardId),
  }),
);
export type IssuingAuthorization =
  typeof issuingAuthorizationsTable.$inferSelect;
export type NewIssuingAuthorization =
  typeof issuingAuthorizationsTable.$inferInsert;

export const terminalReadersTable = pgTable(
  'terminal_readers',
  {
    id: serial('id').primaryKey(),
    userId: integer('user_id')
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('terminal_readers_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
...
export const verificationSessionsTable = pgTable(
  ...
  (table) => ({
    ...
    stripeAccountIdIdx: index('verification_sessions_stripe_account_id_idx').on(
      table.stripeAccountId,
    ),
  }),
);
export type VerificationSession = typeof verificationSessionsTable.$inferSelect;
export type NewVerificationSession =
  typeof verificationSessionsTable.$inferInsert;

export const financialConnectionsAccountsTable = pgTable(
  ...
  (table) => ({
    userIdIdx: index('financial_connections_accounts_user_id_idx').on(
      table.userId,
    ),
    stripeAccountIdIdx: index(
      'financial_connections_accounts_stripe_account_id_idx',
    ).on(table.stripeAccountId),
  }),
);
export type FinancialConnectionsAccount =
  typeof financialConnectionsAccountsTable.$inferSelect;
export type NewFinancialConnectionsAccount =
  typeof financialConnectionsAccountsTable.$inferInsert;
...
export const priceRelations = relations(priceTable, ({ one }) => ({
  ...
  stripeAccount: one(stripeAccounts, {
    fields: [priceTable.stripeAccountId],
    references: [stripeAccounts.id],
  }),
...
export const shippingCodesRelations = relations(
  shippingCodesTable,
  ({ one }) => ({
    user: one(users, {
...
export const usersSettingsRelations = relations(
  usersSettingsTable,
  ({ one }) => ({
    user: one(users, {
...
export const RbackPagesTableRelations = relations(
  RbackPagesTable,
  ({ many }) => ({
...
export const RbackRolesPagesTableRelations = relations(
  RbackRolesPagesTable,
  ({ one }) => ({
    role: one(roles, {
